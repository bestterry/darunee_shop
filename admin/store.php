                      ...
                      <div class="tab-pane" id="store3">
                        <div class="box box-default">
                          ...
                          <div class="box-body">
                            <div class="row">
                              <div class="container">
                                <form action="store_search2.php" method="post">
                                  <div class="col-md-4">
                                    <div class="box-body">
                                      <strong><i class="fa fa-file-text-o margin-r-5"></i> การใช้</strong>
                                      <p> -กรุณาเลือก ระเบียนร้านค้า ส่งแล้ว หรือไม่ได้ส่ง </p>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <select name="month" class="form-control text-center select2"
                                        style="width: 100%;">
                                        <option value="">------กรุณาเลือก------</option>
                                        <option value="succeess">เยี่ยมแล้ว</option>
