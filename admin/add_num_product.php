      ...
      <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <font size="6"><p align = "center"> รายการสินค้าที่ต้องการเพิ่ม </font></p>
            </div>
            <!-- /.box-header -->
                    ...
                    <table class="table table-bordered table-hover">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <input type="text" name="num[]"  class="form-control text-center col-md-2" placeholder="ระบุจำนวน">
                            </td>
                          </tr>
                            <?php 
                                  }
            ...
            <a type="block" href="admin.php" class="btn btn-success"><<= เริ่มต้นใหม่ </i></a>
