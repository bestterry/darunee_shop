                      ...
                      <table id="example2" class="table">
                        ...
                        <tbody>
                          ...
                          <?php 
                             ...
                             if($status == 'N'){
                          ?>
                            <td class="text-center"><a href="algorithm/edit_StatusSong.php?id_song=<?php echo $value['id_song']; ?>" class="btn" >N</a></td>             
                          <?php
                             }else{
                          ?>
                              <td class="text-center"><a href="#" class="btn">Y</a></td>
                            <!-- <td class="text-center"><a href="algorithm/edit_StatusSong.php?id_song=<?php echo $value['id_song']; ?>" class="btn btn-success btn-xs" onClick="return confirm('คุณต้องการที่จะเปลี่ยนสถานะเป็นส่งแล้วหรือไม่ ?')";>Y</a></td>  -->
                          <?php }?> 
