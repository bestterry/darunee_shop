                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input type="text" name="name_product"
                            class="form-control text-center col-md-1" value="<?php echo $objr_edit['name_product'];?>">
                        </td>
                        <td><input type="text" class="form-control text-center col-md-1"
                            value="<?php echo $objr_edit['num'];?>" readonly /></td>
