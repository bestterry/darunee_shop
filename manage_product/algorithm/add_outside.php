  ...
  $before_m = $objr_outside['indebt'];
    ...
    for ($i=0; $i < COUNT($_POST['id_product']); $i++) { 
      ...
      //-------------------------INSERT outside_buy_htr---------------------------------------
        $insert_outside_htr = "INSERT INTO outside_buy_htr (id_outside, id_product, id_zone, num_pd, price_pd, purch_money, balance)
                               VALUE ($id_outside, $id_product, $id_zone, $num_pd, $price_pd, $money, $money)";  
      ...
      //-------------------------/INSERT outside_buy_htr---------------------------------------
       ...
       //-------------------------INSERT outside_buy_htr---------------------------------------
        ...
        $balance = $objr_balance['balance'];
          ...
          $insert_outside_htr = "INSERT INTO outside_buy_htr (id_outside, id_product, id_zone, num_pd, price_pd, purch_money, balance)
                                VALUE ($id_outside, $id_product, $id_zone, $num_pd, $price_pd, $money, $t_balance)";  
          mysqli_query($conn,$insert_outside_htr);
        //-------------------------/INSERT outside_buy_htr---------------------------------------
      }
