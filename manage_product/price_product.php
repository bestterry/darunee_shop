              ...
              <div class="box box-primary"> 
                <form action="price_product_finish.php" method="post" autocomplete="off">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <input class="text-center form-control" type="number" name="num_product[]" placeholder="<?php echo $objr_listproduct['unit'];?>">
                              </td>
                              <td><input class="text-center form-control" type="number" name="price_product[]" step="0.01"  placeholder="ราคา/หน่วย"> </td>
                              <td></td>
                            </tr>
                            <?php 
                                }
                        ...
                        <table class="table table-bordered">
                          <tbody>
                            <tr bgcolor="#99CCFF">
                              ...
                              <th class="text-center"><input class="form-control text-center" type="text" name="note" value="-"></th>
                            </tr>
                          </tbody>
                        </table> 
                      </div>
                  ...
                  <div class="box-footer">
                    <a type="block" href="../product.php" class="btn btn-danger pull-left"><< กลับ </i></a> 
