        ...
        <div class="col-md-10">
          <div class="box box-primary">
            <div class="box-header with-border">
              <font size="5">
                <B> รายการเบิกสินค้า <font color="red"><?php require "../menu/date.php"; ?></font> </B>
              </font>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              ...
              <div class="box-footer">
                ...
                <a type="button" href="../pdf_file/draw_history.php" class="btn btn-success pull-right"><i class="fa fa-print"> พิมพ์ </i> </a>
              </div>
              <!-- /.box-footer -->
            </div>
            <!-- /. box -->
