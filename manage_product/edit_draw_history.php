                ...
                <form action="algorithm/edit_draw_history.php" method="post" autocomplete="off">
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" name="after_num" class="form-control text-center col-md-1"
                            value="<?php echo $objr_product['num_draw'];?>">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-5">
                      ...
                      <a href="algorithm/delete_draw_history.php?id=<?php echo $id_draw_history;?>"
                        class="btn btn-danger"><i class="fa fa-minus-square"> ลบ </i></a>
                    </div>
                    <div class="col-md-3">
                    </div>
                  </div>
