                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" name="money" class="form-control text-center col-md-1"
                            value="<?php echo $objr_product['money']; ?>">
                        </td>
                        <td>
                          <input type="text" name="note" class="form-control text-center col-md-1"
                            value="<?php echo $objr_product['note']; ?>">
                        </td>
                      </tr>
                    </tbody>
                  </table>
            ...
            <div class="box-footer">
              <div class="container">
                <div class="pull-right">
                  ...
                  <a href="algorithm/delete_sale_history.php?id=<?php echo $id_price_product;?>" type="button"
                    class="btn btn-danger"><i class="fa fa-check-square"> ลบ </i></a>
                </div>
              </div>
            </div>
            <!-- /.box-footer -->
