              ...
              <div class="mailbox-read-message">
                <div class="row">
                  <div class="col-5 col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    ...
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label">บ้าน(ม) </label>
                    ...
                    <div class="form-group">
                      <label class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label">ลูกค้า </label>
                      <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 ">
                    ...
                    <div class="form-group">
                        <label class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label">โทร </label>
                        <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 ">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 control-label">
