<?php 
  ...
  $insert_addorder = "INSERT INTO addorder (name_customer, tel, village, district_code, amphur_id, province_id)
                      VALUES ('$name_customer', '$tel', '$village', $id_district, $id_amphur, $id_province)";
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      <div class="table-responsive">
                        <table class="table table-bordered" id="dynamic_field">
                          <tr>
                            <th bgcolor="#99e6ff" width="25%">ชื่อ             :</th>
                            <th width="85%"><?php echo $name_customer; ?></th>
                          </tr>
                          <tr>
                          <th bgcolor="#99e6ff"  width="25%">ที่อยู่            :</th>
                            <th width="85%">
                              <?php 
                          ...
                          <tr>
                          <th bgcolor="#99e6ff" width="25%">เบอร์โทร :</th>
                    ...
                    <div class="col-md-7">
                      <div class="table-responsive">
                        <table class="table table-bordered" id="dynamic_field">
                          <tr>
                            <th bgcolor="#99e6ff" class="text-center" width="70%">สินค้า</th>
                            <th bgcolor="#99e6ff" class="text-center" width="15%">จำนวน</th>
                            <th bgcolor="#99e6ff" class="text-center" width="15%">เงินขาย(บ)</th>
                          </tr>
                          <?php 
                          ...
                          ?>
                          <tr>
                            <td><?php echo $objr_product['name_product'].'_'.$objr_product['unit']; ?></td>
                          ...
                          ?>
                          <tr>
                            <th bgcolor="#99e6ff" class="text-center"></th>
                            <th bgcolor="#99e6ff" class="text-right">รวมเงิน</th>
                            <th bgcolor="#99e6ff" class="text-center"><?php echo $total_price; ?></th>
                          </tr>
                        </table>
                      </div>
                    </div> 
              ...
              <a type="button" href="test.php" class="btn btn-success"><<== กลับ</a>
              </div>
            </div>
            </form>
          </div>
