      ...
      <div class="box box-primary">
          <div class="box-body no-padding">
            <div class="mailbox-read-message">
                ...
                <tbody>
                  <?php 
                      $sql_rs_history = "SELECT * FROM reserve_history 
                                          ...
                                          WHERE reserve_history.id_member = $id_member GROUP BY reserve_history.id_reserve_history DESC";
              ...
              <div class="col-sm-12 text-center">
                <font size="5" color="red">
                  <B> ประวัติรับสำรองจ่าย : <?php echo $username; ?></B>
                </font>
              </div>
              <table class="table" id="example2">
                ...
                <tbody>
                  <?php 
                      $sql_rs_history = "SELECT * FROM reserve_history 
                                          INNER JOIN reserve_list ON reserve_history.id_list = reserve_list.id_list
                                          WHERE reserve_history.id_member = 33 AND reserve_history.id_member_receive = $id_member
