<?php 
  ...
  $id_member_car = $_POST['id_member_car'];
  $money = $_POST['money'];
  ...
  mysqli_query($conn,$update_reserve);
   ...
   $insert_reserve = "INSERT INTO reserve_history (money, transfer, id_list, id_member, id_member_receive, id_member_car, status, note, date)
   VALUE ($money, $total_money, $id_list, $id_member, $id_member, $id_member_car, 4, '$note', '$date')";  
