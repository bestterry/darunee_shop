      ...
      <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header text-center with-border">
              <font size="4">
                <B align="center">เเก้ไขใบสั่งสินค้า <font color="red"> </font></B>
              </font>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <div class="mailbox-read-message">
                <form action="algorithm/edit_list_order_finish.php" class="form-horizontal" method="post" autocomplete="off" name="form1" onSubmit="JavaScript:return fncSubmit();">
                  <div class="row">
                    <div class="col-md-5">
              ...
              <div align="center" class="box-footer">
                <a type="button" href="sent_order.php" class="btn btn-danger pull-left"> <= กลับ</a>
