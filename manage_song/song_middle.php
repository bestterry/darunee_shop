              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <div class="text-center">
                    <font size="5">
                      <B align="center"> เพลงยุคกลาง <font color="red"> </font></B>
                    </font>
                  </div>
                </div>
                                  ...
                                  <tbody>
                                    <?php 
                                      $sql_songslow = "SELECT * FROM song_list
                                                    ...
                                                    WHERE song_list.id_age = 2 AND song_list.id_tune = 1";
                                    ...
                                    <tbody>
                                      <?php 
                                        $sql_songslow = "SELECT * FROM song_list
                                                      ...
                                                      INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                      INNER JOIN song_age ON song_list.id_age = song_age.id_age
                                                      WHERE song_list.id_age = 2 AND song_list.id_tune = 2";
                                        $objq_songslow = mysqli_query($conn,$sql_songslow);
                                        while($value =  $objq_songslow->fetch_assoc()){
                                      ?>
                                      <tr> 
                                    ...
                                    <tbody>
                                      <?php 
                                        $sql_songslow = "SELECT * FROM song_list
                                                      ...
                                                      INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                      INNER JOIN song_age ON song_list.id_age = song_age.id_age
                                                      WHERE song_list.id_age = 2 AND song_list.id_tune = 3";
                                        $objq_songslow = mysqli_query($conn,$sql_songslow);
                                        while($value =  $objq_songslow->fetch_assoc()){
                                      ?>
                                      <tr> 
