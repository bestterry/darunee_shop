                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane active" id="slow">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center">นักร้องยุคกลาง (ช้า)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  ...
                                                  WHERE song_artist.id_ageartist = 2 AND song_list.id_tune = 1";
                      ...
                      <div class="tab-pane" id="middle">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center">นักร้องยุคกลาง (เพลิน)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  INNER JOIN song_artist ON song_list.id_artist = song_artist.id_artist
                                                  INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                  WHERE song_artist.id_ageartist = 2 AND song_list.id_tune = 2";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                                  <tr> 
                      ...
                      <div class="tab-pane" id="fast">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center">นักร้องยุคกลาง (เร็ว)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  INNER JOIN song_artist ON song_list.id_artist = song_artist.id_artist
                                                  INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                  WHERE song_artist.id_ageartist = 2 AND song_list.id_tune = 3";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                                  <tr> 
