          ...
          <div class="row">
            <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8">
              <div class="topnav">
                ...
                <a class="active" href="song_new.php" > ใหม่ </a>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane active" id="slow">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center"> นักร้องใหม่ (ช้า)<font color="red"> </font></B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  ...
                                                  WHERE song_artist.id_ageartist = 3 AND song_list.id_tune = 1";
                      ...
                      <div class="tab-pane" id="middle">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center"> นักร้องใหม่ (เพลิน)<font color="red"> </font></B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  INNER JOIN song_artist ON song_list.id_artist = song_artist.id_artist
                                                  INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                  WHERE song_artist.id_ageartist = 3 AND song_list.id_tune = 2";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                                  <tr> 
                      ...
                      <div class="tab-pane" id="fast">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center"> นักร้องใหม่ (เร็ว)<font color="red"> </font></B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                  INNER JOIN song_artist ON song_list.id_artist = song_artist.id_artist
                                                  INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                  WHERE song_artist.id_ageartist = 3 AND song_list.id_tune = 3";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                                  <tr> 
                                    <td class="text-center">
                                      <?php
                                        if(!empty($value['ad_song'])){
                                      ?>
                                      <a href="song_listen.php?id_song=<?php echo $value['id_song'];?>&&id_ageartist=<?php echo $value['id_ageartist']; ?>" class="btn  btn-success btn-xs" target="_blank">ฟัง</a>
                                      <?php }else{}?>
                                    </td>
                                    <td class="text-center"><?php echo $value['name_artist'];?></td>
                                    <td class="text-center"><?php echo $value['name_song']; ?></td>
