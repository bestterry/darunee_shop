        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-primary">
              ...
              <form action="algorithm\edit_song3.php" class="form-horizontal" method="post" autocomplete="off" name="form1" enctype="multipart/form-data">
                      ...
                      <div class="col-5 col-sm-5 col-md-5 col-xl-5">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            ...
                            <input type="hidden" name="id_artist" class="form-control" value="<?php echo $objr_song['id_artist']; ?>">
                          </div>
                        </div>
