          ...
          <div class="row">
            <div class="col-10 col-xs-10 col-sm-10 col-md-10 col-lg-10">
              <div class="topnav">
                ...
                <a class="active" href="song_coeval.php"> ร่วมสมัย </a>
                  ...
                  <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                              ...
                              <table id="example1" class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr> 
                                    ...
                                    <td class="text-center">
                                      <a href="song_edit.php?id_song=<?php echo $value['id_song']; ?>&&age=coeval" class="btn btn-success btn-xs">>></a>
                                    </td>
                                    <?php
                                      if($value['id_member']==54){
                                      ?>
                                      <td class="text-center">
                                        <a href="algorithm/song_editstatusopen.php?id_song=<?php echo $value['id_song']; ?>&&id_member=<?php echo $id_member;?>&&status=coeval" class="btn btn-success btn-xs">เปิด</a>
                                      </td>
                                      <?php
                                        }else{
                                      ?>
                      ...
                      <div class="tab-pane" id="B">
                        <div align="center" class="box-footer">
                          <font size="5">
                          <B align="center">นักร้องร่วมสมัย (B)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                     ...
                                                     INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                     INNER JOIN member ON song_list.id_member = member.id_member
                                                     WHERE song_artist.id_ageartist = 4 AND song_list.melodic = 'B'
                                                     ORDER BY CONVERT (song_list.name_song USING tis620 ) ASC";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                      ...
                      <div class="tab-pane" id="C">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center">นักร้องร่วมสมัย (C)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
                                ...
                                <tbody>
                                  <?php 
                                    $sql_songslow = "SELECT * FROM song_list
                                                     ...
                                                     INNER JOIN song_tune ON song_list.id_tune = song_tune.id_tune
                                                     INNER JOIN member ON song_list.id_member = member.id_member
                                                     WHERE song_artist.id_ageartist = 4 AND song_list.melodic = 'C'
                                                     ORDER BY CONVERT (song_list.name_song USING tis620 ) ASC";
                                    $objq_songslow = mysqli_query($conn,$sql_songslow);
                                    while($value =  $objq_songslow->fetch_assoc()){
                                  ?>
                      ...
                      <div class="tab-pane" id="D">
                        <div align="center" class="box-footer">
                          <font size="5">
                            <B align="center">นักร้องร่วมสมัย (D)</B>
                          </font>
                        </div>
                        <div class="box-body">
                          <div class="mailbox-read-message">
