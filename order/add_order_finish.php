<?php 
   ...
   // $slip_number = $_POST['slip_number'];
    ...
    $note = $_POST['note'];
     ...
     $sql = "INSERT INTO order_list (id_order_list, list_order, id_product, num_product, date_getorder, date_order, name_sent, tel_sent, catagory_car, licent_plate, name_author, name_store, amphur_id, province_id, name_to, tel_to, note)
                      VALUES ($id_order_list, '$list_order', $id_product,$num_product, '$date_getorder', '$date_order', '$name_sent', '$tel_sent', '$catagory_car','$licent_plate', '$name_author', '$name_store', $amphur_id, $province_id, '$name_to', '$tel_to', '$note')";
